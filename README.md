...
Апрель:
Баранова Полина: финальная сборка и запуск вк-бота, проверка на отсутствие ошибок, создание прототипа для дальнейшей работы с использованием системы искусственного интеллекта, написание тезисов
Цырельчук Анастасия:
Ильина Анастасия:
